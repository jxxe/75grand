...
<main class="p-8">
    <div class="grid grid-cols-display gap-4">
        ...
        <a href="https://forms.gle/34PBLfyLBGSRisqg6" target="_blank" class="p-8 flex flex-col items-center justify-center border-2 border-dashed hover:border-solid border-gray-300 rounded-lg">
            <i class="text-2xl fas fa-plus"></i>
            <span class="text-lg font-semibold">Create a Guide</span>
            <span class="text-gray-400">Share your wisdom</span>
        </a>
    </div>
</main>