<script>
    ...
    const cafeMacHours = [
        ...
        [false, 'dinner till 7pm', 17*hour],
        [true, 'breakfast at 7:30am', 19*hour],

        [false, 'breakfast till 10am', 1*day+7*hour+30*minute],
        [true, 'lunch at 11am', 1*day+10*hour],
        [false, 'lunch till 1:30pm', 1*day+11*hour],
        [true, 'dinner at 5pm', 1*day+13*hour+30*minute],
        [false, 'dinner till 8pm', 1*day+17*hour],
        [true, 'breakfast at 7:30am', 1*day+20*hour],

        [false, 'breakfast till 10am', 2*day+7*hour+30*minute],
        [true, 'lunch at 11am', 2*day+10*hour],
        [false, 'lunch till 1:30pm', 2*day+11*hour],
        [true, 'dinner at 5pm', 2*day+13*hour+30*minute],
        [false, 'dinner till 8pm', 2*day+17*hour],
        [true, 'breakfast at 7:30am', 2*day+20*hour],

        [false, 'breakfast till 10am', 3*day+7*hour+30*minute],
        [true, 'lunch at 11am', 3*day+10*hour],
        [false, 'lunch till 1:30pm', 3*day+11*hour],
        [true, 'dinner at 5pm', 3*day+13*hour+30*minute],
        [false, 'dinner till 8pm', 3*day+17*hour],
        [true, 'breakfast at 7:30am', 3*day+20*hour],

        [false, 'breakfast till 10am', 4*day+7*hour+30*minute],
        [true, 'lunch at 11am', 4*day+10*hour],
        [false, 'lunch till 1:30pm', 4*day+11*hour],
        [true, 'dinner at 5pm', 4*day+13*hour+30*minute],
        [false, 'dinner till 8pm', 4*day+17*hour],
        [true, 'breakfast at 7:30am', 4*day+20*hour],

        [false, 'breakfast till 10am', 5*day+7*hour+30*minute],
        [true, 'lunch at 11am', 5*day+10*hour],
        [false, 'lunch till 1:30pm', 5*day+11*hour],
        [true, 'dinner at 5pm', 5*day+13*hour+30*minute],
        [false, 'dinner till 8pm', 5*day+17*hour],
        [true, 'brunch at 10am', 5*day+20*hour],
