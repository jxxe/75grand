...
<a target={link.url.startsWith('/') ? null : '_blank'} class="group bg-white hover:bg-slate-50 transition-colors px-4 py-3 rounded-lg border border-slate-200 flex gap-3 items-center" href={link.url}>
